...
Для каждого замечания верни boundingBox проблемного элемента: x и y — координаты левого верхнего угла, width и height — размер области. Все значения нормализованы от 0 до 1 относительно полного изображения. Область должна быть достаточно компактной и точно указывать на видимый элемент интерфейса.
